...
int main(int argc, char** argv) {
    ...
    t0 = MPI_Wtime();
    MPI_Scatter(bodysystem_global.x, blockSize, MPI_FLOAT, bodysystem_local.x, blockSize, MPI_FLOAT, MAIN_PROC,
                MPI_COMM_WORLD);
    MPI_Scatter(bodysystem_global.y, blockSize, MPI_FLOAT, bodysystem_local.y, blockSize, MPI_FLOAT, MAIN_PROC,
                MPI_COMM_WORLD);
    MPI_Scatter(bodysystem_global.z, blockSize, MPI_FLOAT, bodysystem_local.z, blockSize, MPI_FLOAT, MAIN_PROC,
                MPI_COMM_WORLD);
    MPI_Scatter(bodysystem_global.vx, blockSize, MPI_FLOAT, bodysystem_local.vx, blockSize, MPI_FLOAT, MAIN_PROC,
                MPI_COMM_WORLD);
    MPI_Scatter(bodysystem_global.vy, blockSize, MPI_FLOAT, bodysystem_local.vy, blockSize, MPI_FLOAT, MAIN_PROC,
                MPI_COMM_WORLD);
    MPI_Scatter(bodysystem_global.vz, blockSize, MPI_FLOAT, bodysystem_local.vz, blockSize, MPI_FLOAT, MAIN_PROC,
                MPI_COMM_WORLD);
    ...
    for (iter = 1; iter <= nIters; iter++) {
        // synchronization
        t0 = MPI_Wtime();
        MPI_Allgather(bodysystem_local.x, blockSize, MPI_FLOAT, bodysystem_global.x, blockSize, MPI_FLOAT,
                      MPI_COMM_WORLD);
        MPI_Allgather(bodysystem_local.y, blockSize, MPI_FLOAT, bodysystem_global.y, blockSize, MPI_FLOAT,
                      MPI_COMM_WORLD);
        MPI_Allgather(bodysystem_local.z, blockSize, MPI_FLOAT, bodysystem_global.z, blockSize, MPI_FLOAT,
                      MPI_COMM_WORLD);
        MPI_Allgather(bodysystem_local.vx, blockSize, MPI_FLOAT, bodysystem_global.vx, blockSize, MPI_FLOAT,
                      MPI_COMM_WORLD);
        MPI_Allgather(bodysystem_local.vy, blockSize, MPI_FLOAT, bodysystem_global.vy, blockSize, MPI_FLOAT,
                      MPI_COMM_WORLD);
        MPI_Allgather(bodysystem_local.vz, blockSize, MPI_FLOAT, bodysystem_global.vz, blockSize, MPI_FLOAT,
                      MPI_COMM_WORLD);
        t1 = MPI_Wtime();
        total_net_time += t1 - t0;
